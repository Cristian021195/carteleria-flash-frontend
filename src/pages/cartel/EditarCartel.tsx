...
export const EditarCartel = () => {
  const [proveedor, setProveedor] = useState<TProveedor>();
  ...
  useEffect(()=>{
    setLoading(true)
    fetch(url+"/cartel/"+id)////, credentials:'include'
    .then(res=>res.json())
    .then(res=>{
      setFData(res);
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (validate()){
      try {
        setLoading(true);
        const pet = await fetch(url+"/cartel/"+id, {
          method:'PUT',
        ...
        if(pet.ok){
          //const res = await pet.json();
          notificate({colors:'bg-green-500 text-white', isvisible:true, value: "Cartel editado correctemente", type:'exito'});
        }else{
          const res = await pet.json();
          ...
          <div className="grid grid-cols-3">
            <div className="col-span-1 p-4 flex-col space-y-4">
              <div className="flex justify-between">
                <label className="w-full flex justify-between items-center"><b>Proveedor Actual:</b> {proveedor?.razon_social} - {proveedor?.nombre} {proveedor?.apellido}</label>
              </div>
              <div className="flex justify-between">
                <label className="w-full flex justify-between items-center"><b>Nuevo Proveedor:</b> {nuevoProveedor?.razon_social} - {nuevoProveedor?.nombre} {nuevoProveedor?.apellido}</label>
              </div>
              <div className="flex justify-between">
                ...
                <div className="relative">
                  <input type="text" name="proveedor" id="proveedor" value={filtroProveedor} 
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <input type="text" name="direccion" id="direccion" onChange={(e)=>{handleChange(e)}}
                    placeholder="Sin información previa"
                    value={fData.direccion ? fData.direccion : ''}
                    className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <input type="number" name="cantidad" id="cantidad" onChange={(e)=>{handleChange(e)}}
                    placeholder="Sin información previa"
                    value={fData.cantidad ? fData.cantidad : ''}
                    className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
            ...
            <div className="col-span-1 p-4 flex-col space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  placeholder="Sin información previa"
                  value={fData.metros_cuadrados ? fData.metros_cuadrados : ''}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  placeholder="Sin información previa"
                  value={fData.cantidad_gestionada ? fData.cantidad_gestionada : ''}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  placeholder="Sin información previa"
                  value={fData.metros_cuadrados_gestionado ? fData.metros_cuadrados_gestionado : ''}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
            ...
            <div className="col-span-1 p-4 flex-col space-y-4">
              <div className="flex justify-between">
                ...
                <div>
                  <input type="number" name="cantidad_privada" id="cantidad_privada" onChange={(e)=>{handleChange(e)}}
                    placeholder="Sin información previa"
                    value={fData.cantidad_privada ? fData.cantidad_privada : ''}
                    className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <input type="number" name="metros_cuadrados_privado" id="metros_cuadrados_privado" onChange={(e)=>{handleChange(e)}}
                    placeholder="Sin información previa"
                    value={fData.metros_cuadrados_privado ? fData.metros_cuadrados_privado : ''}
                    className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  placeholder="Sin información previa"
                  value={fData.cantidad_libre ? fData.cantidad_libre : ''}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <input type="number" name="metros_cuadrados_libre" id="metros_cuadrados_libre" onChange={(e)=>{handleChange(e)}}
                    placeholder="Sin información previa"
                    value={fData.metros_cuadrados_libre ? fData.metros_cuadrados_libre : ''}
                    className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
