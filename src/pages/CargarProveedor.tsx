...
export const CargarProveedor = () => {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const pet = await fetch(url+"/proveedor", {
        method:'POST',
  ...
  return (
    <div className="fade-up">
      <div className="bg-[#222E3C] text-white">
        <h1 className="text-2xl p-2">CARGAR PROVEEDOR</h1>
      </div>
          ...
          <div className="grid grid-cols-3">
            <div className="col-span-1 p-4 flex-col space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <input type="text" name="nombre" id="nombre" required value={fData.nombre} onChange={(e)=>{handleChange(e)}}
              ...
              <div className="flex justify-between">
                ...
                <input type="text" name="apellido" id="apellido" required value={fData.apellido} onChange={(e)=>{handleChange(e)}}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
              </div>

              <div className="flex justify-between">
                <label htmlFor="email" className="w-full">Email: </label>
                <input type="email" name="email" id="email" value={fData.email} required onChange={(e)=>{handleChange(e)}}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
              </div>
            ...
            <div className="col-span-1 p-4 flex-col space-y-4">
              ...
              <div className="flex justify-between">
                <label htmlFor="razon_social" className="w-full">Razon social: </label>
                <input type="text" name="razon_social" id="razon_social" required value={fData.razon_social} onChange={(e)=>{handleChange(e)}}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <input type="number" value={fData.cuit} name="cuit" id="cuit" required placeholder="Ej: 20493868287" onChange={(e)=>{handleChange(e)}}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
              </div>
            </div>
            <div className="col-span-1 p-4 flex-col space-y-4">
              <div className="flex justify-between">
                ...
                <input type="text" value={fData.telefono} name="telefono" id="telefono" required placeholder="Ej: +543852123542" onChange={(e)=>{handleChange(e)}}
                  className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
              </div>
