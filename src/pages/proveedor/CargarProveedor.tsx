    ...
    if(validate()){
      try {
        ...
        if(pet.status >= 200 && pet.status < 300){
          ...
          setFData(init_state);
          notificate({colors:'bg-green-500 text-white', isvisible:true, value: "Provedor cargado correctemente", type:'exito'});
        }else{
          const res = await pet.json();
          ...
          <div className="grid grid-cols-3">
            ...
            <div className="col-span-1 p-4 flex-col space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <input type="text" name="razon_social" id="razon_social" value={fData.razon_social} onChange={(e)=>{handleChange(e)}}
                    className="border-2 border-slate-300 rounded-md focus:border-2 focus:border-slate-500 focus:outline-none ps-1"/>
                  <span className="text-red-500">
